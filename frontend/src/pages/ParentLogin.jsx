...
const ParentLogin = ({ setLoginUser }) => {
  ...
  const login = () => {
    axios.post('http://localhost:9002/parentlogin', user).then((res) => {
  ...
  return (location.pathname === '/ParentLogin')
    ? (
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden bg-[url('https://storage.googleapis.com/msgsndr/Uj1D6UrVHJKU7MfjEQdt/media/64169a0319849c0fc9976e45.png')] bg-cover  bg-center">
